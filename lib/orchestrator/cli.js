...
Commands:
  init <domain=X> [phase=Y]   Initialize orchestrator for a domain
...
Examples:
  ...
  node cli.js init domain=all phase=design
  node cli.js advance
  ...
  switch (command) {
    ...
    default:
      output({
        ...
        usage: 'Commands: init, status, advance, checkpoint, prompt, progress, handoff, reset, help'
      });
      process.exit(1);
  }
}

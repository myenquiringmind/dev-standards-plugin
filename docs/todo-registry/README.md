...
- [TR-0006](TR-0006-rule3-fast-command-planner-conflict.md) — **RESOLVED** (2026-06-19) — sanctioned `fast-command: true` frontmatter marker added to rule 3 (`commands/CLAUDE.md`); `meta-command-composition-reviewer` honours it; `setup.md`/`validate.md` declare it with documented fast-cost rationale. Standing-state `command-composition-reviewer` check now passes without pre-feeding
